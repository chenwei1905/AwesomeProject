...
export default class PickingOrderSortingItem extends Component {
    constructor(props) {
        super(props);
    }
    change(item, index) {
    ...
    render() {
        ...
        if (item.toNo !== null) {
            if (item.confirmed) {
                confirm = (
                    <Text style={{ fontSize: 16, marginRight: 5, marginLeft:5}}> 确认</Text>
                );
            } else {
                confirm = (
                    <Text style={{ fontSize: 16, marginRight: 5,marginLeft:5 }}>未确认</Text>
                );
            }
        } else {
            confirm = <Text style={{ fontSize: 16, marginRight: 5,marginLeft:5 }}></Text>;
        }
        return (
            <View
                style={[
