...
export default class PickingOrderShipmentItem extends Component {
    constructor(props) {
        super(props);
    }
    // change(item,index) {
    ...
    render() {
        ...
        if (item.toNo !== null) {
            if (item.confirmed) {
                confirm = (
                    <Text style={{ fontSize: 16, marginRight: 5 }}> 已确认</Text>
                );
            } else {
                confirm = (
                    <Text style={{ fontSize: 16, marginRight: 5 }}>未确认</Text>
                );
            }
        } else {
            confirm = <Text style={{ fontSize: 16, marginRight: 5 }}></Text>;
        }
